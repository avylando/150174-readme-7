    ...
    <main className="page__main page__main--registration">
      ...
      <section className="registration container">
        ...
        <form
          ...
          action="http://localhost:4000/api/users/register"
          method="post"
          ...
          <div className="form__text-inputs-wrapper">
            <div className="form__text-inputs">
                ...
                <div className="form__input-section">
                  ...
                  <div className="form__error-text">
                    ...
                    <p className="form__error-desc">
                      Текст сообщения об ошибке, подробно объясняющий, что не
                      так.
                    </p>
                  </div>
                </div>
              ...
              <div className="registration__input-wrapper form__input-wrapper">
                ...
                >
                  Логин <span className="form__input-required">*</span>
                </label>
                <div className="form__input-section">
                  <input
                    className="registration__input form__input"
              ...
              <div className="registration__input-wrapper form__input-wrapper">
                ...
                >
                  Пароль<span className="form__input-required">*</span>
                </label>
                <div className="form__input-section">
                  <input
                    className="registration__input form__input"
              ...
              <div className="registration__input-wrapper form__input-wrapper">
                ...
                >
                  Повтор пароля<span className="form__input-required">*</span>
                </label>
                <div className="form__input-section">
                  <input
                    className="registration__input form__input"
